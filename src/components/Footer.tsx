...
export default function Footer({
  ...
  return (
    <div className="fixed top-[87vh] z-50 flex max-w-xs  items-center space-x-3 self-center rounded-xl bg-white drop-shadow-lg dark:border-[1px] dark:border-[#374151] dark:bg-gray-900  sm:max-w-xl">
      <div
        ref={ref}
